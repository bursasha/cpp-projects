...
/**
 * @brief Class representing the VAT Register.
 */
class CVATRegister
{
public:
	...
	/**
	 * @brief Cancel a company registration by name and address.
	 * @param name Company name.
	 * @param addr Company address.
	 * @return True if the company is successfully canceled, false otherwise.
	 */
	bool cancelCompany ( const string &name, const string &addr );

	/**
	 * @brief Cancel a company registration by tax ID.
	 * @param taxID Company tax ID.
	 * @return True if the company is successfully canceled, false otherwise.
	 */
	...
	/**
	 * @brief Add an invoice for a company by tax ID.
	 * @param taxID Company tax ID.
	 * @param amount Invoice amount.
	 * @return True if the invoice is successfully added, false otherwise.
	 */
	bool invoice ( const string &taxID, unsigned int amount );

	/**
	 * @brief Add an invoice for a company by name and address.
	 * @param name Company name.
	 * @param addr Company address.
	 * @param amount Invoice amount.
	 * @return True if the invoice is successfully added, false otherwise.
	...
	/**
	 * @brief Audit a company by name and address to get the sum of invoices.
	 * @param name Company name.
	 * @param addr Company address.
	 * @param sumIncome Reference to store the sum of invoices.
	 * @return True if the company is found, false otherwise.
	 */
	bool audit ( const string &name, const string &addr, unsigned int &sumIncome ) const;

	/**
	 * @brief Audit a company by tax ID to get the sum of invoices.
	 * @param taxID Company tax ID.
	 * @param sumIncome Reference to store the sum of invoices.
	 * @return True if the company is found, false otherwise.
	 */
	...
	/**
	 * @brief Get the first company in the register.
	 * @param name Reference to store the company name.
	 * @param addr Reference to store the company address.
	 * @return True if the first company is found, false otherwise.
	 */
	bool firstCompany ( string &name, string &addr ) const;

	/**
	 * @brief Get the next company in the register.
	 * @param name Reference to store the company name.
	 * @param addr Reference to store the company address.
	 * @return True if the next company is found, false otherwise.
	 */
	...
	/**
	 * @brief Get the median invoice amount.
	 * @return The median invoice amount.
	 */
...
private:
	...
	/**
	 * @brief Compare companies by name and address.
	 * @param inside The existing company.
	 * @param to_compare The company to compare.
	 * @return True if the existing company is less than the company to compare, false otherwise.
	 */
	...
	/**
	 * @brief Compare companies by tax ID.
	 * @param inside The existing company.
	 * @param to_compare The company to compare.
	 * @return True if the existing company is less than the company to compare, false otherwise.
	 */
